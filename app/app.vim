...
set helplang=en
set incsearch
set runtimepath=~/.vim,~/.vim/pack/coc/start/coc.nvim-release,~/.vim/plugged/coc.nvim,~/.vim/plugged/auto-pairs,~/.vim/plugged/vim-surround,~/.vim/plugged/nerdtree,~/.vim/plugged/vim-vue,~/.vim/plugged/emmet-vim,~/.vim/plugged/dockerfile.vim,~/.vim/plugged/vim-code-dark,~/.vim/plugged/iceberg.vim,~/.vim/plugged/sonokai,/usr/local/share/vim/vimfiles,/usr/local/share/vim/vim82,/usr/local/share/vim/vimfiles/after,~/.vim/after
set shiftwidth=2
set smartcase
set smartindent
set softtabstop=2
...
exe 'vert 1resize ' . ((&columns * 69 + 79) / 158)
exe '2resize ' . ((&lines * 14 + 23) / 47)
exe 'vert 2resize ' . ((&columns * 69 + 79) / 158)
exe '3resize ' . ((&lines * 14 + 23) / 47)
exe 'vert 3resize ' . ((&columns * 69 + 79) / 158)
exe 'vert 4resize ' . ((&columns * 88 + 79) / 158)
argglobal
let s:cpo_save=&cpo
set cpo&vim
...
wincmd w
argglobal
if bufexists("routes.py") | buffer routes.py | else | edit routes.py | endif
let s:cpo_save=&cpo
set cpo&vim
inoremap <buffer> <silent> <M-n> :call AutoPairsJump()a
inoremap <buffer> <silent> <expr> <M-p> AutoPairsToggle()
